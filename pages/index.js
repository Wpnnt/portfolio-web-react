      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">developed by wpnnt</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              <a
                href="https://www.linkedin.com/in/paulo-vitor37/"
                target="_blank"
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Desde o início, sempre tive uma grande afinidade pela área de
              desenvolvimento <span className="text-teal-500">web</span>.
              Atualmente, estou focado em expandir meus conhecimentos e criar
              novos projetos nessa área. Abaixo, compartilho alguns dos projetos
              que realizei ao longo do tempo.
            </p>
          </div>
          <div className="grid grid-cols-1 gap-10 py-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
            <div className="flex-1">
              <a
                href="https://wpnnt.github.io/SpotifyClone/"
                target="_blank"
                rel="noreferrer"
              >
                <Image
              ...
              <p className="text-black dark:text-white">
                ...
                <span className="text-teal-500">HTML</span> e{" "}
                <span className="text-teal-500">CSS</span>.
              </p>
            </div>
            <div className="flex-1">
              <a
                href="https://wpnnt.github.io/Tinder-Prototype/"
                target="_blank"
                rel="noreferrer"
              >
                <Image
              ...
              <p className="text-black dark:text-white">
                ...
                <span className="text-teal-500">Bootstrap5</span>.
              </p>
            </div>
            <div className="flex-1">
              <a
                href="https://wpnnt.github.io/Simon-Game-Challenge/"
                target="_blank"
                rel="noreferrer"
              >
                <Image
              ...
              <h3 className="text-3xl py-1 dark:text-white">Simon Game</h3>
            ...
            <div className="flex-1">
              <a
                href="https://wpnnt.github.io/Drum-Kit/"
                target="_blank"
                rel="noreferrer"
              >
                <Image
            ...
            <div className="flex-1">
              <a
                href="https://movie-trailer-umber.vercel.app/"
                target="_blank"
                rel="noreferrer"
              >
                <Image
